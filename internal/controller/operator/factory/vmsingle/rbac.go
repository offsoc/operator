...
func buildClusterRoleBinding(cr *vmv1beta1.VMSingle) *rbacv1.ClusterRoleBinding {
...
func buildClusterRole(cr *vmv1beta1.VMSingle) *rbacv1.ClusterRole {
...
func buildNamespacedRole(cr *vmv1beta1.VMSingle) *rbacv1.Role {
	return &rbacv1.Role{
		ObjectMeta: metav1.ObjectMeta{
			Name:            cr.GetClusterRoleName(),
			Namespace:       cr.GetNamespace(),
...
func buildNamespacedRoleBinding(cr *vmv1beta1.VMSingle) *rbacv1.RoleBinding {
